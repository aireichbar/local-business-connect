...
const FloatingCTA = () => {
  ...
  return (
    <>
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-4 sm:bottom-6 left-4 sm:left-6 z-50 w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-card border border-border shadow-md flex items-center justify-center transition-all duration-300 hover:bg-primary hover:text-white hover:border-primary ${
