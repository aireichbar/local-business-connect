...
const PackagesSection = () => {
  const packages = [
    {
      name: "Einstieg",
      subtitle: "Online-Basis & Auffindbarkeit",
      price: "299",
      priceLabel: "€ einmalig",
      mrr: "39",
      mrrNote: "bei 24 Monaten Laufzeit",
      description: "Online-Basis & Auffindbarkeit",
      features: [
        "Moderne, mobiloptimierte Onepage-Website",
        "Klare Darstellung von Leistungen, Öffnungszeiten und Kontakt",
    ...
    {
      name: "Struktur",
      subtitle: "Digitale Anfragen & Kontaktkanäle",
      price: "499",
      priceLabel: "€ einmalig",
      mrr: "79",
      mrrNote: "bei 24 Monaten Laufzeit",
      description: "Digitale Anfragen & Kontaktkanäle",
      features: [
        "Multi-Page Webseite",
        "SEO optimiert",
        "Mobil optimiert",
        "Kontaktformular inklusive",
        "inkl. 6 Text/Bildänderungen p.a.",
        "DSGVO konform"
      ],
      cta: "Struktur wählen",
      highlighted: true,
    ...
    },
    {
      ...
      subtitle: "Immer erreichbar – ohne Mehraufwand",
      price: "899",
      priceLabel: "€ einmalig",
      mrr: "149",
      mrrNote: "bei 24 Monaten Laufzeit",
      description: "Immer erreichbar – ohne Mehraufwand",
      features: [
        "Automatisierte Annahme eingehender Anrufe, WhatsApps, E-Mails, Chat Nachrichten",
        "Freundliche Erstansprache und Weiterleitung",
